...
a machine-learning based, coordinated
cache and memory management framework that coordinates the management policies at different
memory hierarchy levels to achieve the optimal memory performance,
energy efficiency and reliability.
Our proposed schemes have two steps. The first one
is an enhancement to existing systems. It utilizes existing memory
