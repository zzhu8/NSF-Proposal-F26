...
is executed periodically and upon interrupts from ML components.  With the ML
coordinator, the ML components may help each other in dynamic feature selection,


The collaboration will happen in three forms.  First, they may help each other
in dynamic feature selection.  If an ML component has identified a high-quality


will improve the quality of feature selection as well as speed up the
