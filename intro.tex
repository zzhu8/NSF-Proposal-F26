...
real-world applications are memory-intensive, such as XXX~\cite{XXX}.
Enormous research efforts have been spent to tackle the memory wall
problem~\cite{XXX} at different memory hierarchy levels.  Memory
systems are increasingly complicated, with three levels of caches
